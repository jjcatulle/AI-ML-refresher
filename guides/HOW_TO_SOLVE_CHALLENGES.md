...
- **Week 1, Challenge 6**: Read about "Filtering" in GUIDE_Week1_DataExploration.md
- **Week 4-5, Challenge 5**: Read about "Training Models" in GUIDE_Weeks4-5_ChurnPredictor.md
...
### Step 2: LEARN
From GUIDE_Week1_DataExploration.md, I learn:
...
**Read**: GUIDE_Week1_DataExploration.md → Concept 1
