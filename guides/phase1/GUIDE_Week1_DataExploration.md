...
## Beginner Start Here
If this is your first time with Python or data analysis, this guide is written for you.

### What this week is about
You will learn how to inspect a dataset like a detective:
- What columns exist?
- What data types are present?
- Are there missing values?
- What patterns show up in charts?

### Terms you must know first
- `Dataset`: a collection of rows and columns.
- `Feature`: an input column (for example, age or income).
- `DataFrame`: pandas table object.
- `Missing value`: empty data (`NaN`).
- `Outlier`: unusual value much bigger/smaller than others.
- `Distribution`: how values are spread.

### Modules used
- `pandas`: table data loading and manipulation.
- `numpy`: numerical operations.
- `matplotlib` and `seaborn`: plotting.

### How to study this guide
1. Read one concept section.
2. Run the matching notebook cell.
3. Write 1-2 lines in your own words.
4. Move to next concept only after the current one is clear.
